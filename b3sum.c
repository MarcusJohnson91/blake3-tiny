...
static int sumfile(const char *name, FILE *file, unsigned char *out, size_t outlen) {
    char          buf[16384];
    struct blake3 ctx;
    size_t        len;
...
static int sum(const char *name, FILE *file) {
    size_t i;
...
static int checkfile(const char *name, const char *mode, const char *str, unsigned char *out, size_t len) {
    FILE  *file;
    int    c1, c2;
    size_t i;
...
static int check(const char *name, FILE *file) {
    const char *mode;
